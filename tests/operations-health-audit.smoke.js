...
const report=operationsReport([source],{checkedAt:now,healthObservations:{"camera-a":{httpOk:true,providerConfirmed:true,observedAt:now}}});
...
const partial=operationsReport([source],{checkedAt:now,healthObservations:{"wrong-id":{httpOk:true,providerConfirmed:true,observedAt:now}}});
