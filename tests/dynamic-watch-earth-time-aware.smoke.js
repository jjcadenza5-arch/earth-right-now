...
const base={truth:"LIVE_VIDEO",permission:"EMBED_ALLOWED",health:"HEALTHY",playback:"EMBED",embedUrl:"https://example.com/embed",sourceUrl:"https://example.com",checkedAt,lastSuccessfulCheck:checkedAt,quality:80,freshness:80,moment:70,categories:["Cities"]};
const rows=[
...
console.assert(result[0].id!=="night-nature","dark nature should not outrank stronger current moments");
