...
const r=discoveryResult(sources,"beach",{limit:12});console.assert(r.count===1&&r.windowCount===2&&!r.empty);console.assert(discoveryStatus(r)==="1 destination · 2 near-now views");
