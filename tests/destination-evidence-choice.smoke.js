...
console.assert(sourceChoiceSummary(place,{now})==="1 near-now · 1 at source · 1 reference image · not current","destination choice summary should include honest photo fallback");
...
console.assert(answer.detail.includes("1 near-now view")&&answer.detail.includes("2 views"),"place answer should explain currentness and choice breadth");
