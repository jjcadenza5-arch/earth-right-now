...
for(const bad of ["<script>","a/b","a?b","a#b","%2F"])assert.equal(placeHref(bad),null);
assert.equal(parsePlaceHash("#place=%3Cscript%3E"),null);assert.equal(placeHref("hello earth"),"#place=hello%20earth");
