...
const good=guideAiRequestEnvelope({version:GUIDE_AI_API_VERSION,query:"show me a peaceful coast",language:"en",placeId:"flam",sourceIds:["a","b"],sessionId:"anon_AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"});
assert.equal(good.ok,true);
assert.equal(good.request.sourceIds.length,2);
