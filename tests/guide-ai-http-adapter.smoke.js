...
const context={capabilities:all,catalog,costGuard:{allow:async()=>({allowed:true}),commit:async()=>({allowed:true})},modelAdapter:{generate:async()=>({answer:"A",sourceIds:["a"]})}};
...
console.log("Generative Guide HTTP adapter is fail-closed and no-store");
