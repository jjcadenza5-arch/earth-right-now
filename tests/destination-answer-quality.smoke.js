...
const preview={...base,id:"p",truth:"PREVIEW",playback:"PREVIEW",health:"DEGRADED"};const x=placeAnswer({title:"Reference",sources:[preview],preferred:preview},{now});console.assert(x.detail.startsWith("Reference only · not current."),"preview answer must immediately state that it is not live");
