...
assert.equal(r.total,36);assert.equal(r.valid,36);assert.equal(r.invalid,0);assert.equal(r.placeCoverage,26);assert.equal(r.byIntent.stay,23);assert.equal(r.byIntent.tickets,7);assert.equal(r.byIntent.activities,6);
