...
assert.equal(r.total,31);assert.equal(r.valid,31);assert.equal(r.invalid,0);assert.equal(r.placeCoverage,21);assert.equal(r.byIntent.stay,19);assert.equal(r.byIntent.tickets,6);assert.equal(r.byIntent.activities,6);
