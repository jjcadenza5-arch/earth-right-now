...
assert.equal(r.total,20);assert.equal(r.valid,20);assert.equal(r.invalid,0);assert.equal(r.placeCoverage,15);assert.equal(r.byIntent.stay,15);assert.equal(r.byIntent.tickets,4);assert.equal(r.byIntent.activities,1);
