...
assert.equal(r.total,45);assert.equal(r.valid,45);assert.equal(r.invalid,0);assert.equal(r.placeCoverage,30);assert.equal(r.byIntent.stay,27);assert.equal(r.byIntent.tickets,8);assert.equal(r.byIntent.activities,10);
