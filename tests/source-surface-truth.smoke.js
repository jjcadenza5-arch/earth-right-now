...
console.assert(sourceBadges(preview,{now}).includes("REFERENCE · NOT CURRENT"),"reference fallback must be explicit on cards");
console.assert(operationalNote(preview,{now})==="Reference image — not current","reference operational note must never imply currentness");
