...
console.assert(discoveryStatus({query:"x",count:2,windowCount:3,referenceCount:1,empty:false})==="2 destinations · 2 windows · 1 reference image","search status should distinguish live-like windows from reference images");
