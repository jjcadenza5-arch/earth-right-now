...
console.assert(discoveryStatus({query:"x",count:2,windowCount:3,liveLikeCount:2,currentCount:2,nearNowCount:2,referenceCount:1,empty:false})==="2 destinations · 2 near-now views · 1 reference image","search status should distinguish live-like windows from reference images");
