...
const args=[
 ...
 write("research-review-queue.json",{primary:[{id:"explore",provider:"Explore.org",technicalReady:true,familyTermsState:"CURRENT",requiredHumanAction:"DEPLOYED_HUMAN_PLAYBACK"}],alternates:[{id:"yt"}]}),
 write("source-revalidation-triage.json",{summary:{permissionReview:1,humanMediaReview:2,manualSourceReview:0,editorialRecheck:10,accessLimited:4,retryLater:1,unsampled:5},immediate:[{id:"x",title:"Test",lane:"HUMAN_MEDIA_REVIEW",action:"REVIEW_CURRENT_MEDIA_AND_SOURCE"}]})
];
...
assert.match(r.stdout,/Second-provider primary test/);
assert.match(r.stdout,/Source revalidation triage/);
