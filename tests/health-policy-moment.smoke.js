...
const now=new Date("2026-03-20T12:00:00Z"),s={truth:"LIVE_VIDEO",permission:"EMBED_ALLOWED",health:"HEALTHY",playback:"EMBED",checkedAt:now.toISOString(),lastSuccessfulCheck:now.toISOString(),quality:90,sourceUrl:"https://example.com"};
