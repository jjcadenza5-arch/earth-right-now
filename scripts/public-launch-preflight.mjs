...
for(const [name,html,url] of [["index",index,"https://earthrightnow.app/"],["about",about,"https://earthrightnow.app/about.html"],["privacy",privacy,"https://earthrightnow.app/privacy.html"]]){
...
for(const p of ["manifest.webmanifest","service-worker.js","offline.html","sitemap.xml","robots.txt","CNAME","about.html","privacy.html","release-verification.html"])assert(build.includes(`../${p}`),`release artifact missing ${p}`);
