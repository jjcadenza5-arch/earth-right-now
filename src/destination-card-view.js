...
export function destinationCardView(place,{onOpen,context=""}={}){
  ...
  copy.append(meta,title,region,count,element("small",{className:"destination-choice-summary",text:sourceChoiceSummary(place)}));if(context)copy.append(element("span",{className:"destination-context",text:context}));actions.append(open);card.append(visual,copy,actions);return card;
}
