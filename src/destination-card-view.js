...
export function destinationCardView(place,{onOpen}={}){
  ...
  applyPoster(visual,place.preferred||place.sources?.[0]||place,{label:false});
  ...
  copy.append(meta,title,region,count);actions.append(open);card.append(visual,copy,actions);return card;
}
