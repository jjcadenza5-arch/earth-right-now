...
export function submissionBoundary(record){return{prepared:Boolean(record),published:false,transmitted:false,reviewRequired:Boolean(record),status:record?.status||"NOT_PREPARED"}}
