...
export function bestAvailableWindows(sources,{limit=12}={}){
 return [...(sources||[])].filter(discoverableSource).sort((a,b)=>{const ea=windowEvidenceTier(a),eb=windowEvidenceTier(b);return eb.rank-ea.rank||(truthRank[b.truth]||0)-(truthRank[a.truth]||0)||(playbackRank[b.playback]||0)-(playbackRank[a.playback]||0)}).slice(0,limit);
}
