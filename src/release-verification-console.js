...
const GATES=[
 {key:"browser",title:"Desktop browser",steps:["Open Home, Explore, My Earth, Moments and Living Atlas.","Open and close the immersive viewer.","Verify Previous/Next and source links.","Confirm controls are reachable and layout is not broken."]},
 {key:"mobile",title:"Mobile device / narrow viewport",steps:["Open ERN on a phone or narrow viewport.","Verify Hero actions remain reachable.","Browse Choose a Window horizontally.","Open/close viewer and verify controls remain above the safe area."]},
