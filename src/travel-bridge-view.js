...
export function travelBridgeView(place,{onIntent,offers=[],now=Date.now()}={}){
 ...
 const visible=offers.map(o=>travelOfferView(o,{now})).filter(Boolean);if(visible.length)section.append(element("div",{className:"travel-offers",attrs:{"aria-label":"Verified travel options"}}));
