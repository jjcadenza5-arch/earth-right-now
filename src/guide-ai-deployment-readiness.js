...
export function guideAiDeploymentReadiness(evidence={}){
  ...
  const checks={
    ...
    serverDerivedRateSubject:evidence.serverDerivedRateSubject===true&&evidence.rawNetworkIdentifiersStored===false,
    keyedRateSubjectDerivation:evidence.keyedRateSubjectDerivation===true&&evidence.rawNetworkIdentifiersStored===false,
    idempotency:evidence.idempotency===true,
    modelCancellation:evidence.modelCancellation===true,
