...
const translations={
 en:{home:"Home",watchEarth:"Watch Earth",explore:"Explore",worldMap:"World Map",destinations:"Destinations",seeBefore:"See before you go.",watchNow:"Watch Earth Now",nextMoment:"Next moment",forMoment:"For this moment",beautifulEarth:"Beautiful Earth",earthMotion:"Earth in Motion",natureCalm:"Nature & Calm",nightLights:"Night Lights",anotherSix:"Another six",searchEarth:"Search Earth…",clear:"Clear",allWindows:"All windows",playHere:"Play here",externalLive:"External live",resetLocal:"Reset local suggestions",previous:"Previous",playJourney:"Play journey",pauseJourney:"Pause journey",next:"Next",source:"Source",share:"Share",fullScreen:"Full screen",watch:"Watch",map:"Map",saved:"Saved",heroDeck:"Live views from amazing places around the world. Real conditions. Real moments. A more connected planet.",watchNowEyebrow:"WATCH EARTH NOW",watchSubhead:"A changing world. Always something new to see.",surpriseMe:"Surprise Me",keepWandering:"KEEP WANDERING",morePlaces:"More places worth a look.",exploreEarth:"EXPLORE EARTH",whereLook:"Where do you want to look?",searchDeck:"Search a city, beach, mountain, park, wildlife camera or destination. ERN shows the best truthful window available.",livingAtlas:"LIVING ATLAS",atlasHeading:"The world, one current window at a time.",atlasDeck:"Choose a pin, then open the best available current view for that place.",myEarth:"MY EARTH",myEarthHeading:"Your places, kept local.",myEarthDeck:"Favorites and recent exploration stay in this browser. ERN uses them only to gently improve your For this moment set.",savedWindows:"Saved windows",recentExplored:"Recently explored",continueExploring:"Continue exploring",localOnly:"Based only on your local ERN activity.",aboutWindow:"ABOUT THIS WINDOW",nearbyEarth:"NEARBY ON EARTH",moreLikeThis:"MORE LIKE THIS",beforeGo:"BEFORE YOU GO",stay:"Stay",eat:"Eat",thingsDo:"Things to do",weather:"Weather",goldenHour:"Golden Hour",playHereCount:"play here",daylightCount:"in daylight",nightCityCount:"night-city views",mappedCount:"mapped windows",allPlaces:"All Places",mountains:"Mountains",beaches:"Beaches",cities:"Cities",nature:"Nature",wildlife:"Wildlife",islands:"Islands",parks:"Parks",landmarks:"Landmarks",random:"Random",daylightNow:"Daylight now",guideWhere:"What are you curious to see?",guideIntro:"You do not need the answer first. Start with a place, a mood, or a question.",guideGood:"What’s good now?",guidePeaceful:"Somewhere peaceful",guideGolden:"Golden hour",guideLocal:"Small local place",guideSurprise:"Surprise me",guidePlaceholder:"Try “where does Earth feel quiet right now?”",guideGo:"Go",guideStart:"Ask a question and I’ll open the strongest truthful windows ERN has.",guideAddPlace:"Cameras & places"},
 th:{home:"หน้าแรก",watchEarth:"ชมโลก",explore:"สำรวจ",worldMap:"แผนที่โลก",destinations:"จุดหมาย",seeBefore:"ดูก่อนที่คุณจะไป",watchNow:"ชมโลกตอนนี้",nextMoment:"ช่วงเวลาถัดไป",forMoment:"สำหรับช่วงเวลานี้",beautifulEarth:"โลกที่สวยงาม",earthMotion:"โลกที่เคลื่อนไหว",natureCalm:"ธรรมชาติและความสงบ",nightLights:"แสงไฟยามค่ำ",anotherSix:"อีกหกแห่ง",searchEarth:"ค้นหาโลก…",clear:"ล้าง",allWindows:"ทุกมุมมอง",playHere:"เล่นที่นี่",externalLive:"ไลฟ์ภายนอก",resetLocal:"รีเซ็ตคำแนะนำในเครื่อง",previous:"ก่อนหน้า",playJourney:"เล่นต่อเนื่อง",pauseJourney:"หยุดชั่วคราว",next:"ถัดไป",source:"แหล่งที่มา",share:"แชร์",fullScreen:"เต็มจอ",watch:"ชม",map:"แผนที่",saved:"บันทึก",heroDeck:"มุมมองสดและภาพปัจจุบันจากสถานที่น่าสนใจทั่วโลก สภาพจริง ช่วงเวลาจริง โลกที่เชื่อมถึงกันมากขึ้น",watchNowEyebrow:"ชมโลกตอนนี้",watchSubhead:"โลกกำลังเปลี่ยนแปลง และมีสิ่งใหม่ให้เห็นเสมอ",surpriseMe:"สุ่มให้ฉัน",keepWandering:"เดินทางต่อ",morePlaces:"อีกหลายสถานที่ที่น่าดู",exploreEarth:"สำรวจโลก",whereLook:"คุณอยากมองไปที่ไหน?",searchDeck:"ค้นหาเมือง ชายหาด ภูเขา สวน สัตว์ป่า หรือจุดหมายปลายทาง ERN จะแสดงมุมมองที่ตรงไปตรงมาที่สุด",livingAtlas:"แผนที่โลกมีชีวิต",atlasHeading:"โลกทั้งใบ ผ่านมุมมองปัจจุบันทีละแห่ง",atlasDeck:"เลือกหมุด แล้วเปิดมุมมองปัจจุบันที่ดีที่สุดของสถานที่นั้น",myEarth:"โลกของฉัน",myEarthHeading:"สถานที่ของคุณ เก็บไว้ในเบราว์เซอร์นี้",myEarthDeck:"รายการโปรดและประวัติการสำรวจอยู่ในเบราว์เซอร์นี้เท่านั้น ERN ใช้เพื่อปรับชุดสำหรับช่วงเวลานี้อย่างนุ่มนวล",savedWindows:"มุมมองที่บันทึก",recentExplored:"สำรวจล่าสุด",continueExploring:"สำรวจต่อ",localOnly:"อ้างอิงจากกิจกรรม ERN ในเบราว์เซอร์นี้เท่านั้น",aboutWindow:"เกี่ยวกับมุมมองนี้",nearbyEarth:"สถานที่ใกล้เคียง",moreLikeThis:"คล้ายกัน",beforeGo:"ก่อนที่คุณจะไป",stay:"ที่พัก",eat:"ร้านอาหาร",thingsDo:"สิ่งที่น่าทำ",weather:"อากาศ",goldenHour:"ช่วงแสงทอง",playHereCount:"เล่นที่นี่",daylightCount:"อยู่ในช่วงกลางวัน",nightCityCount:"เมืองยามค่ำ",mappedCount:"อยู่บนแผนที่",allPlaces:"ทุกสถานที่",mountains:"ภูเขา",beaches:"ชายหาด",cities:"เมือง",nature:"ธรรมชาติ",wildlife:"สัตว์ป่า",islands:"เกาะ",parks:"สวน",landmarks:"แลนด์มาร์ก",random:"สุ่ม",daylightNow:"กลางวันตอนนี้",guideWhere:"ตอนนี้คุณอยากรู้อะไรบนโลก?",guideIntro:"ไม่ต้องมีคำตอบก่อน เริ่มจากสถานที่ บรรยากาศ หรือคำถามก็ได้",guideGood:"ตอนนี้มีอะไรน่าดู?",guidePeaceful:"ที่ไหนสักแห่งที่สงบ",guideGolden:"ช่วงแสงทอง",guideLocal:"สถานที่เล็กๆ แบบท้องถิ่น",guideSurprise:"สุ่มให้ฉัน",guidePlaceholder:"ลองถาม “ตอนนี้ที่ไหนบนโลกสงบ?”",guideGo:"ไป",guideStart:"ถามมาได้เลย แล้ว ERN จะเปิดมุมมองที่ตรงความจริงและแข็งแรงที่สุดให้",guideAddPlace:"กล้องและสถานที่"},
 de:{home:"Start",watchEarth:"Erde ansehen",explore:"Entdecken",worldMap:"Weltkarte",destinations:"Ziele",seeBefore:"Sehen, bevor du gehst.",watchNow:"Erde jetzt ansehen",nextMoment:"Nächster Moment",forMoment:"Für diesen Moment",beautifulEarth:"Schöne Erde",earthMotion:"Erde in Bewegung",natureCalm:"Natur & Ruhe",nightLights:"Nachtlichter",anotherSix:"Sechs weitere",searchEarth:"Erde durchsuchen…",clear:"Löschen",allWindows:"Alle Fenster",playHere:"Hier abspielen",externalLive:"Extern live",resetLocal:"Lokale Vorschläge zurücksetzen",previous:"Zurück",playJourney:"Reise starten",pauseJourney:"Pause",next:"Weiter",source:"Quelle",share:"Teilen",fullScreen:"Vollbild",watch:"Ansehen",map:"Karte",saved:"Gespeichert",heroDeck:"Live- und aktuelle Ansichten bemerkenswerter Orte weltweit. Echte Bedingungen. Echte Momente. Eine stärker verbundene Welt.",watchNowEyebrow:"ERDE JETZT ANSEHEN",watchSubhead:"Eine Welt in Bewegung. Immer etwas Neues zu sehen.",surpriseMe:"Überrasch mich",keepWandering:"WEITERWANDERN",morePlaces:"Weitere Orte, die einen Blick wert sind.",exploreEarth:"ERDE ENTDECKEN",whereLook:"Wohin möchtest du schauen?",searchDeck:"Suche nach Stadt, Strand, Berg, Park, Tierwelt oder Reiseziel. ERN zeigt das beste ehrliche aktuelle Fenster.",livingAtlas:"LEBENDER ATLAS",atlasHeading:"Die Welt, ein aktuelles Fenster nach dem anderen.",atlasDeck:"Wähle einen Punkt und öffne die beste verfügbare aktuelle Ansicht.",myEarth:"MEINE ERDE",myEarthHeading:"Deine Orte, lokal gespeichert.",myEarthDeck:"Favoriten und zuletzt erkundete Orte bleiben in diesem Browser.",savedWindows:"Gespeicherte Fenster",recentExplored:"Zuletzt erkundet",continueExploring:"Weiter entdecken",localOnly:"Nur basierend auf deiner lokalen ERN-Nutzung.",aboutWindow:"ÜBER DIESES FENSTER",nearbyEarth:"IN DER NÄHE",moreLikeThis:"ÄHNLICHE ORTE",beforeGo:"BEVOR DU GEHST",stay:"Übernachten",eat:"Essen",thingsDo:"Aktivitäten",weather:"Wetter",goldenHour:"Goldene Stunde",playHereCount:"hier abspielbar",daylightCount:"bei Tageslicht",nightCityCount:"Nachtstadt-Ansichten",mappedCount:"kartierte Fenster",allPlaces:"Alle Orte",mountains:"Berge",beaches:"Strände",cities:"Städte",nature:"Natur",wildlife:"Tierwelt",islands:"Inseln",parks:"Parks",landmarks:"Sehenswürdigkeiten",random:"Zufall",daylightNow:"Jetzt Tageslicht",guideWhere:"Was möchtest du gerade entdecken?",guideIntro:"Du brauchst die Antwort nicht vorher. Beginne mit einem Ort, einer Stimmung oder einer Frage.",guideGood:"Was ist gerade gut?",guidePeaceful:"Irgendwo ruhig",guideGolden:"Goldene Stunde",guideLocal:"Kleiner lokaler Ort",guideSurprise:"Überrasch mich",guidePlaceholder:"Frag z. B. „Wo fühlt sich die Erde gerade ruhig an?“",guideGo:"Los",guideStart:"Stell eine Frage und ERN öffnet die verlässlichsten passenden Fenster.",guideAddPlace:"Kameras & Orte"},
 fr:{home:"Accueil",watchEarth:"Voir la Terre",explore:"Explorer",worldMap:"Carte du monde",destinations:"Destinations",seeBefore:"Voir avant de partir.",watchNow:"Voir la Terre maintenant",nextMoment:"Moment suivant",forMoment:"Pour cet instant",beautifulEarth:"Belle Terre",earthMotion:"Terre en mouvement",natureCalm:"Nature & calme",nightLights:"Lumières de nuit",anotherSix:"Six autres",searchEarth:"Rechercher sur Terre…",clear:"Effacer",allWindows:"Toutes les vues",playHere:"Lire ici",externalLive:"Live externe",resetLocal:"Réinitialiser les suggestions locales",previous:"Précédent",playJourney:"Lancer le voyage",pauseJourney:"Pause",next:"Suivant",source:"Source",share:"Partager",fullScreen:"Plein écran",watch:"Voir",map:"Carte",saved:"Enregistré",heroDeck:"Vues en direct et actuelles de lieux remarquables dans le monde. Conditions réelles. Moments réels. Une planète plus connectée.",watchNowEyebrow:"VOIR LA TERRE MAINTENANT",watchSubhead:"Un monde qui change. Toujours quelque chose de nouveau à voir.",surpriseMe:"Surprenez-moi",keepWandering:"CONTINUER À EXPLORER",morePlaces:"D’autres lieux qui valent le détour.",exploreEarth:"EXPLORER LA TERRE",whereLook:"Où voulez-vous regarder ?",searchDeck:"Recherchez une ville, une plage, une montagne, un parc, des animaux ou une destination. ERN affiche la meilleure vue actuelle et honnête.",livingAtlas:"ATLAS VIVANT",atlasHeading:"Le monde, une fenêtre actuelle à la fois.",atlasDeck:"Choisissez un point puis ouvrez la meilleure vue actuelle disponible.",myEarth:"MA TERRE",myEarthHeading:"Vos lieux, conservés localement.",myEarthDeck:"Les favoris et l’exploration récente restent dans ce navigateur.",savedWindows:"Fenêtres enregistrées",recentExplored:"Exploré récemment",continueExploring:"Continuer à explorer",localOnly:"Basé uniquement sur votre activité ERN locale.",aboutWindow:"À PROPOS DE CETTE VUE",nearbyEarth:"À PROXIMITÉ",moreLikeThis:"DANS LE MÊME ESPRIT",beforeGo:"AVANT DE PARTIR",stay:"Séjourner",eat:"Manger",thingsDo:"À faire",weather:"Météo",goldenHour:"Heure dorée",playHereCount:"lisibles ici",daylightCount:"en plein jour",nightCityCount:"vues urbaines de nuit",mappedCount:"fenêtres cartographiées",allPlaces:"Tous les lieux",mountains:"Montagnes",beaches:"Plages",cities:"Villes",nature:"Nature",wildlife:"Faune",islands:"Îles",parks:"Parcs",landmarks:"Sites",random:"Aléatoire",daylightNow:"En plein jour",guideWhere:"Qu’avez-vous envie de découvrir ?",guideIntro:"Vous n’avez pas besoin de connaître la réponse. Commencez par un lieu, une ambiance ou une question.",guideGood:"Que voir maintenant ?",guidePeaceful:"Un endroit calme",guideGolden:"Heure dorée",guideLocal:"Petit lieu local",guideSurprise:"Surprenez-moi",guidePlaceholder:"Essayez « Où la Terre semble-t-elle calme maintenant ? »",guideGo:"Voir",guideStart:"Posez une question et ERN ouvrira les vues fiables les plus pertinentes.",guideAddPlace:"Caméras et lieux"},
 ja:{home:"ホーム",watchEarth:"地球を見る",explore:"探索",worldMap:"世界地図",destinations:"行き先",seeBefore:"行く前に見る。",watchNow:"今の地球を見る",nextMoment:"次の瞬間",forMoment:"今この瞬間",beautifulEarth:"美しい地球",earthMotion:"動く地球",natureCalm:"自然と静けさ",nightLights:"夜の灯り",anotherSix:"別の6か所",searchEarth:"地球を検索…",clear:"クリア",allWindows:"すべて",playHere:"ここで再生",externalLive:"外部ライブ",resetLocal:"ローカル提案をリセット",previous:"前へ",playJourney:"自動再生",pauseJourney:"一時停止",next:"次へ",source:"ソース",share:"共有",fullScreen:"全画面",watch:"見る",map:"地図",saved:"保存",heroDeck:"世界のすばらしい場所から、ライブまたは現在の景色を。実際の状況、実際の瞬間、よりつながる地球。",watchNowEyebrow:"今の地球を見る",watchSubhead:"変わり続ける世界。いつも新しい景色があります。",surpriseMe:"おまかせ",keepWandering:"さらに旅する",morePlaces:"まだ見てみたい場所。",exploreEarth:"地球を探索",whereLook:"どこを見たいですか？",searchDeck:"都市、ビーチ、山、公園、野生動物、目的地を検索。ERNは最も正直な現在の景色を表示します。",livingAtlas:"リビングアトラス",atlasHeading:"今この瞬間の窓から世界を見る。",atlasDeck:"ピンを選んで、その場所の最良の現在ビューを開きます。",myEarth:"マイ・アース",myEarthHeading:"あなたの場所を、このブラウザに。",myEarthDeck:"お気に入りと最近の探索はこのブラウザ内だけに保存されます。",savedWindows:"保存したビュー",recentExplored:"最近見た場所",continueExploring:"探索を続ける",localOnly:"このブラウザ内のERN利用だけに基づきます。",aboutWindow:"このビューについて",nearbyEarth:"近くの場所",moreLikeThis:"似た場所",beforeGo:"行く前に",stay:"泊まる",eat:"食べる",thingsDo:"すること",weather:"天気",goldenHour:"ゴールデンアワー",playHereCount:"ここで再生",daylightCount:"昼の景色",nightCityCount:"夜の都市",mappedCount:"地図上のビュー",allPlaces:"すべて",mountains:"山",beaches:"ビーチ",cities:"都市",nature:"自然",wildlife:"野生動物",islands:"島",parks:"公園",landmarks:"名所",random:"ランダム",daylightNow:"現在昼間",guideWhere:"今、何を見つけてみたいですか？",guideIntro:"最初から答えを知る必要はありません。場所、雰囲気、質問から始めてください。",guideGood:"今は何がいい？",guidePeaceful:"静かな場所",guideGolden:"ゴールデンアワー",guideLocal:"小さなローカルスポット",guideSurprise:"おまかせ",guidePlaceholder:"「今、地球のどこが静か？」と聞いてみてください",guideGo:"見る",guideStart:"質問すると、ERNが確認できる最も確かな窓を開きます。",guideAddPlace:"カメラと場所"},
 zh:{home:"首页",watchEarth:"观看地球",explore:"探索",worldMap:"世界地图",destinations:"目的地",seeBefore:"出发前先看看。",watchNow:"现在看地球",nextMoment:"下一个时刻",forMoment:"此刻推荐",beautifulEarth:"美丽地球",earthMotion:"流动的地球",natureCalm:"自然与宁静",nightLights:"夜色灯光",anotherSix:"再看六个",searchEarth:"搜索地球…",clear:"清除",allWindows:"全部窗口",playHere:"站内播放",externalLive:"外部直播",resetLocal:"重置本地推荐",previous:"上一个",playJourney:"自动播放",pauseJourney:"暂停",next:"下一个",source:"来源",share:"分享",fullScreen:"全屏",watch:"观看",map:"地图",saved:"收藏",heroDeck:"来自世界各地精彩地点的直播与当前画面。真实状况，真实时刻，更互联的地球。",watchNowEyebrow:"现在看地球",watchSubhead:"不断变化的世界，总有新的景象。",surpriseMe:"随机看看",keepWandering:"继续漫游",morePlaces:"更多值得一看的地方。",exploreEarth:"探索地球",whereLook:"你想看哪里？",searchDeck:"搜索城市、海滩、山脉、公园、野生动物或目的地。ERN展示最真实可靠的当前窗口。",livingAtlas:"动态地图",atlasHeading:"一次一个当前窗口，看遍世界。",atlasDeck:"选择一个地点，然后打开最佳可用当前画面。",myEarth:"我的地球",myEarthHeading:"你的地点，仅保存在本地。",myEarthDeck:"收藏和最近探索只保存在这个浏览器中。",savedWindows:"已收藏窗口",recentExplored:"最近探索",continueExploring:"继续探索",localOnly:"仅基于你在本地浏览器中的ERN活动。",aboutWindow:"关于此窗口",nearbyEarth:"附近地点",moreLikeThis:"类似地点",beforeGo:"出发前",stay:"住宿",eat:"餐饮",thingsDo:"值得做",weather:"天气",goldenHour:"黄金时刻",playHereCount:"站内播放",daylightCount:"当前白天",nightCityCount:"夜间城市",mappedCount:"地图窗口",allPlaces:"所有地点",mountains:"山脉",beaches:"海滩",cities:"城市",nature:"自然",wildlife:"野生动物",islands:"岛屿",parks:"公园",landmarks:"地标",random:"随机",daylightNow:"当前白天",guideWhere:"此刻你想发现什么？",guideIntro:"不必先知道答案。从一个地点、氛围或问题开始就好。",guideGood:"现在有什么值得看？",guidePeaceful:"安静的地方",guideGolden:"黄金时刻",guideLocal:"小而本地的地方",guideSurprise:"随机看看",guidePlaceholder:"试试问“此刻地球上哪里最安静？”",guideGo:"查看",guideStart:"问一个问题，ERN 会打开最可靠、最符合的窗口。",guideAddPlace:"摄像头与地点"},
 es:{home:"Inicio",watchEarth:"Ver la Tierra",explore:"Explorar",worldMap:"Mapa mundial",destinations:"Destinos",seeBefore:"Mira antes de ir.",watchNow:"Ver la Tierra ahora",nextMoment:"Siguiente momento",forMoment:"Para este momento",beautifulEarth:"Tierra hermosa",earthMotion:"Tierra en movimiento",natureCalm:"Naturaleza y calma",nightLights:"Luces nocturnas",anotherSix:"Otros seis",searchEarth:"Buscar en la Tierra…",clear:"Limpiar",allWindows:"Todas las vistas",playHere:"Ver aquí",externalLive:"Live externo",resetLocal:"Restablecer sugerencias locales",previous:"Anterior",playJourney:"Iniciar viaje",pauseJourney:"Pausar",next:"Siguiente",source:"Fuente",share:"Compartir",fullScreen:"Pantalla completa",watch:"Ver",map:"Mapa",saved:"Guardado",heroDeck:"Vistas en vivo y actuales de lugares extraordinarios del mundo. Condiciones reales. Momentos reales. Un planeta más conectado.",watchNowEyebrow:"VER LA TIERRA AHORA",watchSubhead:"Un mundo en cambio. Siempre hay algo nuevo que ver.",surpriseMe:"Sorpréndeme",keepWandering:"SEGUIR EXPLORANDO",morePlaces:"Más lugares que merecen una mirada.",exploreEarth:"EXPLORAR LA TIERRA",whereLook:"¿Dónde quieres mirar?",searchDeck:"Busca una ciudad, playa, montaña, parque, fauna o destino. ERN muestra la mejor ventana actual y honesta disponible.",livingAtlas:"ATLAS VIVO",atlasHeading:"El mundo, una ventana actual a la vez.",atlasDeck:"Elige un punto y abre la mejor vista actual disponible.",myEarth:"MI TIERRA",myEarthHeading:"Tus lugares, guardados localmente.",myEarthDeck:"Los favoritos y la exploración reciente permanecen en este navegador.",savedWindows:"Ventanas guardadas",recentExplored:"Explorado recientemente",continueExploring:"Seguir explorando",localOnly:"Basado solo en tu actividad local en ERN.",aboutWindow:"SOBRE ESTA VISTA",nearbyEarth:"CERCA EN LA TIERRA",moreLikeThis:"MÁS COMO ESTO",beforeGo:"ANTES DE IR",stay:"Alojamiento",eat:"Comer",thingsDo:"Qué hacer",weather:"Clima",goldenHour:"Hora dorada",playHereCount:"se reproducen aquí",daylightCount:"con luz diurna",nightCityCount:"vistas urbanas nocturnas",mappedCount:"ventanas en el mapa",allPlaces:"Todos los lugares",mountains:"Montañas",beaches:"Playas",cities:"Ciudades",nature:"Naturaleza",wildlife:"Fauna",islands:"Islas",parks:"Parques",landmarks:"Lugares emblemáticos",random:"Aleatorio",daylightNow:"Con luz ahora",guideWhere:"¿Qué te da curiosidad descubrir?",guideIntro:"No necesitas saber la respuesta de antemano. Empieza con un lugar, un ambiente o una pregunta.",guideGood:"¿Qué vale la pena ver ahora?",guidePeaceful:"Un lugar tranquilo",guideGolden:"Hora dorada",guideLocal:"Lugar pequeño y local",guideSurprise:"Sorpréndeme",guidePlaceholder:"Prueba «¿Dónde se siente tranquila la Tierra ahora?»",guideGo:"Ver",guideStart:"Haz una pregunta y ERN abrirá las ventanas fiables que mejor encajen.",guideAddPlace:"Cámaras y lugares"}
}
let lang=readSavedText("ern-language","en");if(!translations[lang])lang="en";
const extraTranslations={
 en:{askGuide:"Ask ERN Guide",currentWindows:"current windows.",localEarth:"LOCAL EARTH",localEarthHeading:"Small places deserve a window too.",localEarthDeck:"Villages, local markets, farms, harbours, neighbourhoods and smaller destinations can be worth seeing even when they are not famous.",growView:"GROW THE VIEW",growHeading:"Places, cameras and moments.",growDeck:"ERN can grow through camera owners, local places and temporary visitor observations without turning ranking into advertising.",camerasPlaces:"Cameras & places",camerasPlacesDeck:"See how camera owners and places can prepare a source for ERN review. Nothing is published without rights, truth and source-health checks.",localPlacesBusiness:"Local places & small businesses",localPlacesDeck:"Learn how useful smaller places can become discoverable. Payment never buys ERN ranking.",exploreNowMoments:"Explore Now Moments",nowMomentsDeck:"Preview ERN’s short-lived visitor observations locally. Public sharing stays off until moderation and privacy infrastructure are ready.",aboutSources:"About & sources",forPlacesCameras:"For places & cameras",privacy:"Privacy"},
 th:{askGuide:"ถาม ERN Guide",currentWindows:"มุมมองปัจจุบัน",localEarth:"โลกท้องถิ่น",localEarthHeading:"สถานที่เล็ก ๆ ก็ควรมีหน้าต่างให้มองเห็น",localEarthDeck:"หมู่บ้าน ตลาดท้องถิ่น ฟาร์ม ท่าเรือ ย่านชุมชน และจุดหมายเล็ก ๆ ก็น่าดูได้แม้ไม่ใช่สถานที่ดัง",growView:"ร่วมขยายมุมมอง",growHeading:"สถานที่ กล้อง และช่วงเวลาต่าง ๆ",growDeck:"ERN เติบโตได้จากเจ้าของกล้อง สถานที่ท้องถิ่น และข้อสังเกตชั่วคราวจากผู้เยี่ยมชม โดยไม่เปลี่ยนการจัดอันดับให้เป็นโฆษณา",camerasPlaces:"กล้องและสถานที่",camerasPlacesDeck:"ดูวิธีเตรียมแหล่งภาพสำหรับการตรวจสอบของ ERN โดยจะไม่เผยแพร่จนกว่าจะตรวจสอบสิทธิ์ ความจริง และสุขภาพของแหล่งข้อมูล",localPlacesBusiness:"สถานที่ท้องถิ่นและธุรกิจขนาดเล็ก",localPlacesDeck:"ดูว่าสถานที่เล็ก ๆ ที่มีประโยชน์จะถูกค้นพบได้อย่างไร การจ่ายเงินไม่เคยซื้ออันดับใน ERN",exploreNowMoments:"สำรวจ Now Moments",nowMomentsDeck:"ทดลองดูข้อสังเกตระยะสั้นของ ERN ในเบราว์เซอร์นี้ การแชร์สาธารณะยังปิดอยู่จนกว่าระบบดูแลและความเป็นส่วนตัวจะพร้อม",aboutSources:"เกี่ยวกับ ERN และแหล่งข้อมูล",forPlacesCameras:"สำหรับสถานที่และกล้อง",privacy:"ความเป็นส่วนตัว"},
 de:{askGuide:"ERN Guide fragen",currentWindows:"aktuelle Fenster.",localEarth:"LOKALE ERDE",localEarthHeading:"Auch kleine Orte verdienen ein Fenster.",localEarthDeck:"Dörfer, lokale Märkte, Bauernhöfe, Häfen, Viertel und kleinere Ziele können sehenswert sein, auch wenn sie nicht berühmt sind.",growView:"DIE SICHT ERWEITERN",growHeading:"Orte, Kameras und Momente.",growDeck:"ERN kann durch Kamerabetreiber, lokale Orte und kurzlebige Besucherbeobachtungen wachsen, ohne Ranking in Werbung zu verwandeln.",camerasPlaces:"Kameras & Orte",camerasPlacesDeck:"So können Kamerabetreiber und Orte eine Quelle für die ERN-Prüfung vorbereiten. Veröffentlicht wird erst nach Prüfung von Rechten, Wahrheit und Quellenzustand.",localPlacesBusiness:"Lokale Orte & kleine Betriebe",localPlacesDeck:"Erfahren Sie, wie nützliche kleinere Orte auffindbar werden können. Bezahlung kauft niemals ERN-Ranking.",exploreNowMoments:"Now Moments entdecken",nowMomentsDeck:"ERNs kurzlebige Besucherbeobachtungen lokal ansehen. Öffentliches Teilen bleibt aus, bis Moderation und Datenschutz-Infrastruktur bereit sind.",aboutSources:"Über ERN & Quellen",forPlacesCameras:"Für Orte & Kameras",privacy:"Datenschutz"},
 fr:{askGuide:"Demander à ERN Guide",currentWindows:"fenêtres actuelles.",localEarth:"TERRE LOCALE",localEarthHeading:"Les petits lieux méritent aussi une fenêtre.",localEarthDeck:"Villages, marchés locaux, fermes, ports, quartiers et petites destinations peuvent valoir le détour même s’ils ne sont pas célèbres.",growView:"AGRANDIR LA VUE",growHeading:"Lieux, caméras et moments.",growDeck:"ERN peut grandir grâce aux propriétaires de caméras, aux lieux locaux et aux observations temporaires des visiteurs, sans transformer le classement en publicité.",camerasPlaces:"Caméras et lieux",camerasPlacesDeck:"Découvrez comment préparer une source pour l’examen ERN. Rien n’est publié sans vérification des droits, de la vérité et de l’état de la source.",localPlacesBusiness:"Lieux locaux et petites entreprises",localPlacesDeck:"Découvrez comment des lieux plus petits et utiles peuvent devenir visibles. Le paiement n’achète jamais le classement ERN.",exploreNowMoments:"Explorer Now Moments",nowMomentsDeck:"Prévisualisez localement les observations temporaires d’ERN. Le partage public reste désactivé jusqu’à ce que la modération et la protection de la vie privée soient prêtes.",aboutSources:"À propos & sources",forPlacesCameras:"Pour les lieux & caméras",privacy:"Confidentialité"},
 ja:{askGuide:"ERN Guide に聞く",currentWindows:"現在の窓。",localEarth:"ローカル・アース",localEarthHeading:"小さな場所にも、世界への窓を。",localEarthDeck:"村、市場、農場、港、地域の街角、小さな目的地も、有名でなくても見る価値があります。",growView:"景色を広げる",growHeading:"場所、カメラ、そして今この瞬間。",growDeck:"ERNは、カメラ所有者、地域の場所、短時間の訪問者観察から成長できますが、ランキングを広告にはしません。",camerasPlaces:"カメラと場所",camerasPlacesDeck:"カメラ所有者や場所がERN審査用の情報を準備する方法を確認できます。権利、真実性、情報源の状態を確認するまで公開しません。",localPlacesBusiness:"地域の場所と小さな事業者",localPlacesDeck:"役立つ小さな場所が見つけられる仕組みを紹介します。支払いでERNの順位を買うことはできません。",exploreNowMoments:"Now Moments を見る",nowMomentsDeck:"短時間だけ有効な訪問者観察をこのブラウザ内で試せます。公開共有は、モデレーションとプライバシー基盤が整うまで無効です。",aboutSources:"ERNと情報源について",forPlacesCameras:"場所・カメラ向け",privacy:"プライバシー"},
 zh:{askGuide:"询问 ERN Guide",currentWindows:"个当前窗口。",localEarth:"本地地球",localEarthHeading:"小地方也值得拥有一扇窗口。",localEarthDeck:"村庄、本地市场、农场、港口、社区和较小的目的地，即使并不知名，也值得看看。",growView:"拓展视野",growHeading:"地点、摄像头与此刻。",growDeck:"ERN 可以通过摄像头所有者、本地地点和短时访客观察不断成长，同时不让排名变成广告。",camerasPlaces:"摄像头与地点",camerasPlacesDeck:"了解如何为 ERN 审核准备来源。只有在权利、真实性和来源状态通过检查后才会发布。",localPlacesBusiness:"本地地点与小型商家",localPlacesDeck:"了解有用的小地方如何被发现。付费永远不能购买 ERN 排名。",exploreNowMoments:"探索 Now Moments",nowMomentsDeck:"在本地预览 ERN 的短时访客观察。公共分享会保持关闭，直到审核和隐私基础设施准备就绪。",aboutSources:"关于 ERN 与来源",forPlacesCameras:"地点与摄像头",privacy:"隐私"},
 es:{askGuide:"Preguntar a ERN Guide",currentWindows:"ventanas actuales.",localEarth:"TIERRA LOCAL",localEarthHeading:"Los lugares pequeños también merecen una ventana.",localEarthDeck:"Pueblos, mercados locales, granjas, puertos, barrios y destinos pequeños pueden merecer una mirada aunque no sean famosos.",growView:"AMPLIAR LA VISTA",growHeading:"Lugares, cámaras y momentos.",growDeck:"ERN puede crecer gracias a propietarios de cámaras, lugares locales y observaciones temporales de visitantes sin convertir el ranking en publicidad.",camerasPlaces:"Cámaras y lugares",camerasPlacesDeck:"Consulta cómo preparar una fuente para la revisión de ERN. Nada se publica sin comprobar derechos, veracidad y estado de la fuente.",localPlacesBusiness:"Lugares locales y pequeños negocios",localPlacesDeck:"Descubre cómo lugares pequeños y útiles pueden hacerse visibles. Pagar nunca compra una posición en ERN.",exploreNowMoments:"Explorar Now Moments",nowMomentsDeck:"Previsualiza localmente las observaciones temporales de ERN. El uso compartido público permanece desactivado hasta que estén listas la moderación y la infraestructura de privacidad.",aboutSources:"Acerca de ERN y fuentes",forPlacesCameras:"Para lugares y cámaras",privacy:"Privacidad"}
};
const finishTranslations={
 en:{verifiedTravelNote:"Verified travel options are shown only when current. Affiliate or sponsored links are disclosed and never affect ERN ranking.",about:"About",samePlanet:"Same Planet",brighterPerspectives:"Brighter Perspectives",heroHeadline1:"A more",heroHeadline2:"connected world.",featuredNow:"Featured now",featuredReason:"Chosen for quality, local light and variety.",personalizedBrowser:"Personalized in this browser",watchEmpty:"No strong current windows match this filter right now. Try another category or “For this moment.”",realPlaces:"⌂ Real places",liveCurrentViews:"▣ Live & current views",globalPerspective:"● Global perspective",connectedWorld:"◒ A more connected world",wanderNote:"Curated from healthy sources outside the current Top 20.",localPlaces:"Local places",playsInErn:"Plays in ERN",providerView:"Provider view",reviewedLocal:"Reviewed local place",beyondPins:"Beyond the mapped pins",nothingSaved:"Nothing saved yet. Tap ♡ while watching a window.",recentEmpty:"Places you explore will appear here for quick return.",connectingWindow:"Connecting to this window…",providerSlow:"If the provider is slow, you can still open the original source.",tryAnotherView:"Try another view",openSource:"Open source",planningNote:"Useful external planning links for this place. Earth-view ranking is independent of commercial relationships.",nowMoments:"Now Moments"},
 th:{verifiedTravelNote:"ตัวเลือกการเดินทางจะแสดงเมื่อข้อมูลยังเป็นปัจจุบันเท่านั้น ลิงก์พันธมิตรหรือผู้สนับสนุนจะมีการเปิดเผยอย่างชัดเจนและไม่ส่งผลต่อการจัดอันดับ ERN",about:"เกี่ยวกับ",samePlanet:"โลกใบเดียวกัน",brighterPerspectives:"มุมมองที่สดใสขึ้น",heroHeadline1:"โลกที่",heroHeadline2:"เชื่อมถึงกันมากขึ้น",featuredNow:"แนะนำตอนนี้",featuredReason:"คัดเลือกจากคุณภาพ แสงท้องถิ่น และความหลากหลาย",personalizedBrowser:"ปรับให้เหมาะในเบราว์เซอร์นี้",watchEmpty:"ตอนนี้ไม่มีมุมมองปัจจุบันที่เหมาะกับตัวกรองนี้ ลองหมวดอื่นหรือ “สำหรับช่วงเวลานี้”",realPlaces:"⌂ สถานที่จริง",liveCurrentViews:"▣ มุมมองสดและปัจจุบัน",globalPerspective:"● มุมมองทั่วโลก",connectedWorld:"◒ โลกที่เชื่อมถึงกันมากขึ้น",wanderNote:"คัดเลือกจากแหล่งข้อมูลที่แข็งแรงนอกชุด Top 20 ปัจจุบัน",localPlaces:"สถานที่ท้องถิ่น",playsInErn:"เล่นใน ERN",providerView:"มุมมองจากผู้ให้บริการ",reviewedLocal:"สถานที่ท้องถิ่นที่ผ่านการตรวจสอบ",beyondPins:"นอกเหนือจากหมุดบนแผนที่",nothingSaved:"ยังไม่มีรายการที่บันทึก แตะ ♡ ขณะชมมุมมอง",recentEmpty:"สถานที่ที่คุณสำรวจจะปรากฏที่นี่เพื่อกลับมาได้ง่าย",connectingWindow:"กำลังเชื่อมต่อมุมมองนี้…",providerSlow:"หากผู้ให้บริการช้า คุณยังเปิดแหล่งต้นฉบับได้",tryAnotherView:"ลองมุมมองอื่น",openSource:"เปิดแหล่งข้อมูล",planningNote:"ลิงก์วางแผนภายนอกสำหรับสถานที่นี้ การจัดอันดับมุมมองโลกไม่ขึ้นกับความสัมพันธ์เชิงพาณิชย์",nowMoments:"Now Moments"},
 de:{verifiedTravelNote:"Geprüfte Reiseoptionen werden nur angezeigt, wenn sie aktuell sind. Affiliate- oder gesponserte Links werden offengelegt und beeinflussen niemals das ERN-Ranking.",about:"Über ERN",samePlanet:"Derselbe Planet",brighterPerspectives:"Neue Perspektiven",heroHeadline1:"Eine stärker",heroHeadline2:"verbundene Welt.",featuredNow:"Jetzt ausgewählt",featuredReason:"Ausgewählt nach Qualität, lokalem Licht und Vielfalt.",personalizedBrowser:"In diesem Browser personalisiert",watchEmpty:"Für diesen Filter gibt es gerade keine starken aktuellen Fenster. Probiere eine andere Kategorie oder „Für diesen Moment“.",realPlaces:"⌂ Echte Orte",liveCurrentViews:"▣ Live- & aktuelle Ansichten",globalPerspective:"● Globale Perspektive",connectedWorld:"◒ Eine stärker verbundene Welt",wanderNote:"Kuratiert aus gesunden Quellen außerhalb der aktuellen Top 20.",localPlaces:"Lokale Orte",playsInErn:"In ERN abspielbar",providerView:"Anbieteransicht",reviewedLocal:"Geprüfter lokaler Ort",beyondPins:"Jenseits der Kartenpunkte",nothingSaved:"Noch nichts gespeichert. Tippe beim Ansehen auf ♡.",recentEmpty:"Erkundete Orte erscheinen hier zum schnellen Wiederfinden.",connectingWindow:"Verbindung zu diesem Fenster…",providerSlow:"Wenn der Anbieter langsam ist, kannst du die Originalquelle öffnen.",tryAnotherView:"Andere Ansicht",openSource:"Quelle öffnen",planningNote:"Nützliche externe Planunglinks für diesen Ort. Die Rangfolge der Erdansichten ist unabhängig von kommerziellen Beziehungen.",nowMoments:"Now Moments"},
 fr:{verifiedTravelNote:"Les options de voyage vérifiées ne sont affichées que lorsqu’elles sont à jour. Les liens affiliés ou sponsorisés sont signalés et n’influencent jamais le classement ERN.",about:"À propos",samePlanet:"Même planète",brighterPerspectives:"Nouvelles perspectives",heroHeadline1:"Un monde",heroHeadline2:"plus connecté.",featuredNow:"Sélection du moment",featuredReason:"Choisi pour la qualité, la lumière locale et la variété.",personalizedBrowser:"Personnalisé dans ce navigateur",watchEmpty:"Aucune vue actuelle forte ne correspond à ce filtre. Essayez une autre catégorie ou « Pour cet instant ».",realPlaces:"⌂ Lieux réels",liveCurrentViews:"▣ Vues live et actuelles",globalPerspective:"● Perspective mondiale",connectedWorld:"◒ Un monde plus connecté",wanderNote:"Sélectionné parmi des sources fiables hors du Top 20 actuel.",localPlaces:"Lieux locaux",playsInErn:"Lecture dans ERN",providerView:"Vue du fournisseur",reviewedLocal:"Lieu local vérifié",beyondPins:"Au-delà des points cartographiés",nothingSaved:"Rien d’enregistré. Touchez ♡ en regardant une vue.",recentEmpty:"Les lieux explorés apparaîtront ici pour y revenir rapidement.",connectingWindow:"Connexion à cette vue…",providerSlow:"Si le fournisseur est lent, vous pouvez ouvrir la source d’origine.",tryAnotherView:"Essayer une autre vue",openSource:"Ouvrir la source",planningNote:"Liens externes utiles pour préparer une visite. Le classement des vues Earth est indépendant des relations commerciales.",nowMoments:"Now Moments"},
 ja:{verifiedTravelNote:"確認済みの旅行オプションは、現在有効な場合のみ表示されます。アフィリエイトやスポンサーリンクは明示され、ERNのランキングには影響しません。",about:"ERNについて",samePlanet:"同じ地球",brighterPerspectives:"新しい視点",heroHeadline1:"もっと",heroHeadline2:"つながる世界へ。",featuredNow:"今のおすすめ",featuredReason:"品質、現地の光、バランスをもとに選択。",personalizedBrowser:"このブラウザ内でパーソナライズ",watchEmpty:"この条件に合う強い現在ビューはありません。別のカテゴリか「今この瞬間」を試してください。",realPlaces:"⌂ 実在する場所",liveCurrentViews:"▣ ライブ・現在ビュー",globalPerspective:"● 世界の視点",connectedWorld:"◒ もっとつながる世界",wanderNote:"現在のTop 20以外の健全な情報源から選んでいます。",localPlaces:"地域の場所",playsInErn:"ERN内で再生",providerView:"提供元で見る",reviewedLocal:"確認済みの地域スポット",beyondPins:"地図ピンの外にも",nothingSaved:"まだ保存はありません。ビューを見ながら♡をタップしてください。",recentEmpty:"見た場所がここに表示され、すぐ戻れます。",connectingWindow:"このビューに接続中…",providerSlow:"提供元が遅い場合も、元のソースを開けます。",tryAnotherView:"別のビュー",openSource:"ソースを開く",planningNote:"この場所の外部プランニングリンクです。Earthビューの順位は商業関係に左右されません。",nowMoments:"Now Moments"},
 zh:{verifiedTravelNote:"已验证的旅行选项仅在信息仍然有效时显示。联盟或赞助链接会明确披露，并且绝不会影响 ERN 排名。",about:"关于",samePlanet:"同一个地球",brighterPerspectives:"更明亮的视角",heroHeadline1:"一个更加",heroHeadline2:"相连的世界。",featuredNow:"此刻精选",featuredReason:"根据质量、当地光线与多样性选择。",personalizedBrowser:"仅在此浏览器中个性化",watchEmpty:"当前没有符合此筛选条件的优质窗口。请尝试其他类别或“此刻推荐”。",realPlaces:"⌂ 真实地点",liveCurrentViews:"▣ 直播与当前画面",globalPerspective:"● 全球视角",connectedWorld:"◒ 更加相连的世界",wanderNote:"从当前 Top 20 之外的健康来源中精选。",localPlaces:"本地地点",playsInErn:"在 ERN 中播放",providerView:"提供方视图",reviewedLocal:"已审核本地地点",beyondPins:"地图图钉之外",nothingSaved:"尚未收藏。观看窗口时点按 ♡。",recentEmpty:"你探索过的地点会显示在这里，方便快速返回。",connectingWindow:"正在连接此窗口…",providerSlow:"如果提供方较慢，你仍可打开原始来源。",tryAnotherView:"尝试其他视图",openSource:"打开来源",planningNote:"此地点的实用外部规划链接。Earth 视图排名不受商业关系影响。",nowMoments:"Now Moments"},
 es:{verifiedTravelNote:"Las opciones de viaje verificadas solo se muestran cuando están actualizadas. Los enlaces afiliados o patrocinados se identifican claramente y nunca afectan al ranking de ERN.",about:"Acerca de",samePlanet:"El mismo planeta",brighterPerspectives:"Nuevas perspectivas",heroHeadline1:"Un mundo",heroHeadline2:"más conectado.",featuredNow:"Destacado ahora",featuredReason:"Elegido por calidad, luz local y variedad.",personalizedBrowser:"Personalizado en este navegador",watchEmpty:"No hay ventanas actuales destacadas que coincidan con este filtro. Prueba otra categoría o «Para este momento».",realPlaces:"⌂ Lugares reales",liveCurrentViews:"▣ Vistas en vivo y actuales",globalPerspective:"● Perspectiva global",connectedWorld:"◒ Un mundo más conectado",wanderNote:"Seleccionado de fuentes saludables fuera del Top 20 actual.",localPlaces:"Lugares locales",playsInErn:"Se reproduce en ERN",providerView:"Vista del proveedor",reviewedLocal:"Lugar local revisado",beyondPins:"Más allá de los puntos del mapa",nothingSaved:"Todavía no hay nada guardado. Toca ♡ mientras ves una ventana.",recentEmpty:"Los lugares que explores aparecerán aquí para volver rápidamente.",connectingWindow:"Conectando con esta ventana…",providerSlow:"Si el proveedor tarda, todavía puedes abrir la fuente original.",tryAnotherView:"Probar otra vista",openSource:"Abrir fuente",planningNote:"Enlaces externos útiles para planificar este lugar. El ranking de vistas de Earth es independiente de relaciones comerciales.",nowMoments:"Now Moments"}
};
...
function renderContext(s){
 ...
 if(commercial.length){
  ...
  note.textContent=t("planningNote");
 }
